 ...
 * @author shubham
 */
@WebServlet(name = "WorkerTypesServlet", urlPatterns = {"/workerTypesMain"})
public class WorkerTypesServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        try {
            ...
            Logger.getLogger(WorkerTypesServlet.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
